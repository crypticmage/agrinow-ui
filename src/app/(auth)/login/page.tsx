...
import { ThreeCanvas } from "@/components/login/ThreeCanvas";
import { EntranceWrapper } from "@/components/login/EntranceWrapper";
    ...
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#0d1a0f]">
      ...
      <div className="pointer-events-none absolute inset-0" aria-hidden="true">
        ...
        >
          ...
          <circle cx="110" cy="110" r="70" stroke="#4ade80" strokeWidth="0.5" strokeDasharray="4 6" />
          <circle cx="110" cy="110" r="40" stroke="#4ade80" strokeWidth="0.5" />
          <line x1="10" y1="110" x2="210" y2="110" stroke="#4ade80" strokeWidth="0.5" strokeDasharray="3 5" />
          <line x1="110" y1="10" x2="110" y2="210" stroke="#4ade80" strokeWidth="0.5" strokeDasharray="3 5" />
        </svg>
        <svg
        ...
        >
          ...
          <path
            ...
            stroke="#4ade80" strokeWidth="0.6" strokeDasharray="3 4" fill="none"
          />
        </svg>
      </div>

      {/* Main content — staggered entrance via client wrapper */}
